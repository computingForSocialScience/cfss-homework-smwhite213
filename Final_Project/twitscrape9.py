...
#for page in range(1,12):
    ...
    #for person in congresspeople:
        ...
        tup=(lastname,firstname,twitterid,state,party,avgneg,avgneu,avgpos,avgcomp,persontweets)
...
if not countI==0:
    ...
    print "(There are no Independents in this sampel.)"
